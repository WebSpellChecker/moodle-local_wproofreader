...
$string['customer_id_desc'] = 'Paste the license key delivered with your Moodle Marketplace purchase. Leave empty to use the free version. The license key unlocks unlimited grammar checking and the AI writing assistant.';
