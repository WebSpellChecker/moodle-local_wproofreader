...
$string['rule_covered_many'] = 'Adds nothing new: rules {$a} already grant this.';
$string['rule_covered_one'] = 'Adds nothing new: rule {$a} already grants this.';
$string['rule_edit'] = 'Edit';
$string['rule_edit_label'] = 'Edit rule {$a->number}: {$a->sentence}';
...
$string['rule_repeats_many'] = 'Repeats rules {$a}.';
$string['rule_repeats_one'] = 'Repeats rule {$a}.';
$string['rule_role'] = 'Role';
$string['rule_role_missing'] = 'A role that no longer exists';
$string['rule_save'] = 'Save';
...
$string['rules_filter_feature'] = 'Any feature';
$string['rules_filter_role'] = 'Any role';
$string['rules_nomatch'] = 'No rule matches the filter.';
$string['rules_none'] = 'No rules yet. WProofreader stays off everywhere until at least one rule is added.';
$string['rules_number'] = '#';
$string['rules_rule'] = 'Rule';
$string['rules_showing'] = 'Showing {$a->shown} of {$a->total}.';
$string['rules_sort'] = 'Sort by';
$string['rules_sort_added'] = 'Order added';
