...
$string['customer_id_desc'] = 'Paste the license key delivered with your Moodle Marketplace purchase. Leave empty to use the free version. The license key lifts the daily usage limitation, unlocks enhanced grammar checking, the AI writing assistant, access to custom dictionaries and style guide functionality.';
...
$string['slang_auto'] = 'Auto';
$string['slang_desc'] = 'The language WProofreader uses by default. Pick "Auto" to let the service detect the language from the content being checked. Users can switch languages from the badge menu while editing.';
